        ...
        if ProtName.DEBUG_INSERT_DB:
            ...
            if raw != None:
                ...
                if ProtName.DEBUG_INSERT_DB:
                    ...
                    ####          ####
                    #### FIN TODO ####
                    idProt = curDB.var(cx_Oracle.NUMBER)
                    ...
                    curDB.execute (None, {'prot_name': self._name, 'name_kind': self._name_kind, 'name_type': self._name_type ,'id': idProt})
                    prot_name_id = idProt.getvalue()[0]
